...
var info = {
    type: 'instructions',
    pages: [
        header + '<h2>Participant Consent</h2> By continuing, you are consenting to our study.</p> ' // for the online version, this is where the participant downloads and reads the consent form before pressing Next.
    ],
